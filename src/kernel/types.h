...
typedef uint16_t WORD, USHORT, CSHORT;
...
#define STATUS_INVALID_PARAMETER ((XboxTypes::NTSTATUS)0xC000000DL)
#define STATUS_INVALID_HANDLE ((XboxTypes::NTSTATUS)0xC0000008L)
#define STATUS_HANDLE_NOT_CLOSABLE ((XboxTypes::NTSTATUS)0xC0000235L)
...
#define STATUS_SINGLE_STEP ((XboxTypes::NTSTATUS)0x80000004L)
#define STATUS_BUFFER_OVERFLOW ((XboxTypes::NTSTATUS)0x80000005L)
#define STATUS_ACCESS_VIOLATION ((XboxTypes::NTSTATUS)0xC0000005L)
#define STATUS_IN_PAGE_ERROR ((XboxTypes::NTSTATUS)0xC0000006L)
#define STATUS_NO_MEMORY ((XboxTypes::NTSTATUS)0xC0000017L)
#define STATUS_ILLEGAL_INSTRUCTION ((XboxTypes::NTSTATUS)0xC000001DL)
#define STATUS_BUFFER_TOO_SMALL ((XboxTypes::NTSTATUS)0xC0000023L)
#define STATUS_NONCONTINUABLE_EXCEPTION ((XboxTypes::NTSTATUS)0xC0000025L)
#define STATUS_INVALID_DISPOSITION ((XboxTypes::NTSTATUS)0xC0000026L)
#define STATUS_OBJECT_NAME_INVALID ((XboxTypes::NTSTATUS)0xC0000033L)
#define STATUS_OBJECT_NAME_NOT_FOUND ((XboxTypes::NTSTATUS)0xC0000034L)
#define STATUS_OBJECT_NAME_COLLISION ((XboxTypes::NTSTATUS)0xC0000035L)
#define STATUS_ARRAY_BOUNDS_EXCEEDED ((XboxTypes::NTSTATUS)0xC000008CL)
#define STATUS_FLOAT_DENORMAL_OPERAND ((XboxTypes::NTSTATUS)0xC000008DL)
#define STATUS_FLOAT_DIVIDE_BY_ZERO ((XboxTypes::NTSTATUS)0xC000008EL)
#define STATUS_FLOAT_INEXACT_RESULT ((XboxTypes::NTSTATUS)0xC000008FL)
#define STATUS_FLOAT_INVALID_OPERATION ((XboxTypes::NTSTATUS)0xC0000090L)
#define STATUS_FLOAT_OVERFLOW ((XboxTypes::NTSTATUS)0xC0000091L)
#define STATUS_FLOAT_STACK_CHECK ((XboxTypes::NTSTATUS)0xC0000092L)
#define STATUS_FLOAT_UNDERFLOW ((XboxTypes::NTSTATUS)0xC0000093L)
#define STATUS_INTEGER_DIVIDE_BY_ZERO ((XboxTypes::NTSTATUS)0xC0000094L)
#define STATUS_INTEGER_OVERFLOW ((XboxTypes::NTSTATUS)0xC0000095L)
#define STATUS_PRIVILEGED_INSTRUCTION ((XboxTypes::NTSTATUS)0xC0000096L)
#define STATUS_DATA_OVERRUN ((XboxTypes::NTSTATUS)0xC000003CL)
#define STATUS_INVALID_IMAGE_FORMAT ((XboxTypes::NTSTATUS)0xC000007BL)
#define STATUS_INSUFFICIENT_RESOURCES ((XboxTypes::NTSTATUS)0xC000009AL)
#define STATUS_STACK_OVERFLOW ((XboxTypes::NTSTATUS)0xC00000FDL)
#define STATUS_CONTROL_C_EXIT ((XboxTypes::NTSTATUS)0xC000013AL)
#define STATUS_TOO_MANY_SECRETS ((XboxTypes::NTSTATUS)0xC0000156L)
...
#define UNICODE_NULL ((XboxTypes::WCHAR)0)
